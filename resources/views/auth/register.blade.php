...
<head>
  ...
  <title>Hire Now Registration Candidate</title>
      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="{{ route('register') }}" method="post" class="sign-up-form">
            ...
            <img src="{{ asset('storage/home_page/HireNow-Logo.png') }}" alt="" />
</div>

            <h4 class="title">Register as Job Seeker</h4>
            ...
            <div class="input-field">
              ...
              <input type="tel" placeholder="Phone" name="phone" value="{{ old('email') }}" required />
            </div>
            <div class="input-field">
            ...
            <p class="social-text">Already have an account? <a href="{{ route('login') }}" style="text-decoration: none;color:#56196d; font-weight: bold;">Login</a></p>
          </form>
        </div>
      </div>
